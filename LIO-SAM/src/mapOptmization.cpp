...
public:
    ...
    void publishOdometry()
    {
        ...
        // Do not publish a second odom -> lidar TF here.
        // In this integration, robot_state_publisher owns base_link -> laser_link,
        // and TransformFusion owns odom -> base_link. Publishing odom -> lidarFrame
        // here creates a conflicting second parent for the lidar frame.
